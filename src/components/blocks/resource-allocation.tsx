...
const topItems = [
  {
    title: "Standardized task templates.",
    description:
      "Create and reuse best-practice templates so teams can onboard faster and ship consistently.",
    images: [
      {
  ...
  {
    title: "Centralized integrations.",
    description:
      "Connect Jira, Asana, Drive and more so your planning and execution live in one place—no context switching.",
    images: [
...
const bottomItems = [
  {
    title: "Archive stale tasks.",
    description:
      "Automatically move completed or stale items out of active boards so teams stay focused on current work.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "Keep decision context close to the work with threaded discussions attached to tasks and milestones.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "Smart notifications that cut through the noise and surface the updates that matter to your role.",
    images: [
      {
    ...
    <section id="resource-allocation" className="overflow-hidden pb-28 lg:pb-32">
      <div className="">
        <h2 className="container text-center text-3xl tracking-tight text-balance sm:text-4xl md:text-5xl lg:text-6xl">
          Worksense — plan and allocate resources with confidence
        </h2>
